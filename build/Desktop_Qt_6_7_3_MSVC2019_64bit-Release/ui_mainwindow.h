...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 1084, 209));
        ...
        connectionLabel = new QLabel(scrollAreaWidgetContents_2);
        connectionLabel->setObjectName("connectionLabel");

        gridLayout_2->addWidget(connectionLabel, 1, 0, 1, 1);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1084, 526));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        connectionLabel->setText(QCoreApplication::translate("MainWindow", "TextLabel", nullptr));
    } // retranslateUi
